...
SRCS := main.cpp flecs.c mainer.c EgMotion.c EgMats.c EgVideo.c EgTypes.c EgDraws.c mat.c deps/opencv/cvmats.cpp deps/opencv/draw.cpp deps/opencv/VideoReader.cpp $(oflow)
